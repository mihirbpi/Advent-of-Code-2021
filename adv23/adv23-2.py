...
def pretty_print(state):
    ...
    third_depth = " ##"
    for key in rooms:
        third_depth += rooms[key][2] + "#"
    third_depth += "# "
    print(third_depth)
    fourth_depth = " ##"
    for key in rooms:
        fourth_depth += rooms[key][3] + "#"
    fourth_depth += "# "
    print(fourth_depth)
    print(" ########### \n")
...
def can_move_into_room(hallway, room, occupant, hall_index):
    ...
    elif(room[0] == "." and room[1] == "." and room[2] == occupant):
        distance = abs(hall_index - room_col) + 2
        return distance, 1

    elif(room[0] == "." and room[1] == "." and room[2] == "." and room[3] == occupant):
        distance = abs(hall_index - room_col) + 3
        return distance, 2

    elif(room[0] == "." and room[1] == "." and room[2] == "." and room[3] == "."):
        distance = abs(hall_index - room_col) + 4
        return distance, 3
    ...
    if(key in DP):
       return DP[key]
        ...
        for room in rooms:
                ...
                for index in range(room_col, len(hallway)):
                    ...
                    if(hallway[index] != "."):
                        break
                            ...
                            if(rooms[occupant][0] == "." and rooms[occupant][1] == occupant and contains_only(occupant, rooms)):
                                distance = 2 + abs(index - room_col)
                                places_can_move_to.append([-1, distance])


                            elif(rooms[occupant][0] == "." and rooms[occupant][1] == "." and rooms[occupant][2] == occupant  and contains_only(occupant, rooms)):
                                distance = 3 + abs(index - room_col)
                                places_can_move_to.append([-2, distance])


                            elif(rooms[occupant][0] == "." and rooms[occupant][1] == "." and rooms[occupant][2] == "." and rooms[occupant][3] == occupant  and contains_only(occupant, rooms)):
                                distance = 4 + abs(index - room_col)
                                places_can_move_to.append([-3, distance])


                            elif(rooms[occupant][0] == "." and rooms[occupant][1] == "." and rooms[occupant][2] == "." and rooms[occupant][3] == "."  and contains_only(occupant, rooms)):
                                distance = 5 + abs(index - room_col)
                                places_can_move_to.append([-4, distance])
            ...
            elif(rooms[room][0] == "." and rooms[room][1] == "." and rooms[room][2] != "."  and rooms[room][2] != room):
                occupant = rooms[room][0]
                room_col = 2*(ord(room)-64)
                occupant_col = 2*(ord(occupant)-64)
        ...
        for room in rooms:
            ...
            elif(rooms[room][0] == "." and rooms[room][1] == "." and rooms[room][2] != "."  and should_move_0(room, rooms)):
                occupant = rooms[room][2]
                occupant_col = 2*(ord(occupant)-64)
                room_col = 2*(ord(room)-64)
                places_can_move_to = []
            ...
            elif(rooms[room][0] == "." and rooms[room][1] == "." and rooms[room][2] == "." and rooms[room][3] != "."  and should_move_0(room, rooms)):
                occupant = rooms[room][3]
                occupant_col = 2*(ord(occupant)-64)
                room_col = 2*(ord(room)-64)
                places_can_move_to = []
